...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "https://frontend-production-134c.up.railway.app", "https://smartcalendar-production-1b76.up.railway.app/login"],
